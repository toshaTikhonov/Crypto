...
static void Md5Process( Md5Context *ctx, const UINT8 data[64] )
{
    UINT32 X[16], A, B, C, D;
 ...
 * MD5 final digest
 */
void Md5Result( Md5Context *ctx, UINT8 output[16] )
{
    ...
    Md5Input( ctx, (PUINT8) md5_padding, (UINT16)padn );
    Md5Input( ctx, msglen, 8 );
